...
/**
 * Test case for class Tx_Nxshowroom_Domain_Model_Image.
 *
 * @version $Id$
 ...
 */
class Tx_Nxshowroom_Domain_Model_ImageTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Nxshowroom_Domain_Model_Image
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Nxshowroom_Domain_Model_Image();
	}
