...
/**
 * Test case for class Tx_Nxshowroom_Controller_TypeController.
 *
 * @version $Id$
 ...
 */
class Tx_Nxshowroom_Controller_TypeControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_Nxshowroom_Domain_Model_Type();
	}
