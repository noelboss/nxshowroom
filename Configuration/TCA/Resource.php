	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_nxshowroom_domain_model_resource.pid=###CURRENT_PID### AND tx_nxshowroom_domain_model_resource.sys_language_uid IN (-1,0)',
			),
		),
		...
		'title' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nxshowroom/Resources/Private/Language/locallang_db.xml:tx_nxshowroom_domain_model_resource.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'description' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nxshowroom/Resources/Private/Language/locallang_db.xml:tx_nxshowroom_domain_model_resource.description',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
		...
		'resource' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nxshowroom/Resources/Private/Language/locallang_db.xml:tx_nxshowroom_domain_model_resource.resource',
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'tx_nxshowroom_domain_model_resource',
		...
		'tags' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:nxshowroom/Resources/Private/Language/locallang_db.xml:tx_nxshowroom_domain_model_resource.tags',
			'config' => array(
				'type' => 'select',
				...
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_nxshowroom_domain_model_tags',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
						'script' => 'wizard_add.php',
