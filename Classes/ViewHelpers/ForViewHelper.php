 ...
 * @api
 */
class Tx_Nxshowroom_ViewHelpers_ForViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 * @param boolean $sort If set to true the array will be sorted
